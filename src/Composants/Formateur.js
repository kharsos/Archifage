...
export default function Formateur(){
    ...
    <div className='split'>
        <header>
            <div>
                <h2 style={{color:'#152259',marginLeft:'10px'}}>{formateur.name}</h2>
            </div>
            <div>
        ...
        <section>
            ...
            <div className="filter" style={{marginTop:'20px'}}>
                <select id="filiere" style={{margin:'0px 10px'}} className="form-select" onClick={(e)=>setChosenFiliere(e.target.value)}>
                    <option disabled selected value={''}>Choisisser la filere</option>
                    {filieres.map((f,i)=><option value={f} key={i}>{f}</option>)}
                </select>
                <select id="module" style={{margin:'0px 10px'}} className="form-select" onClick={(e)=>{setChosenModule(e.target.value)}}>
                    <option disabled selected value={''}>Choisisser le module</option>
                    {modules.map((m,i)=><option value={m} key={i}>{m}</option>)}
                </select>
                <select id="grp" style={{margin:'0px 10px'}} className="form-select" onClick={(e)=>{setChosenGroupe(e.target.value)}}>
                    <option disabled selected value={''}>Choisisser le groupe</option>
