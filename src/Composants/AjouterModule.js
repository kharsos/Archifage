...
export default function AjouterModule(){
    ...
    <nav className="nav">
       ...
       <Link to={'/Admin/Groupes'}><button type='button' className="btns" style={{backgroundColor:'transparent',border:'none'}}><img src="http://localhost:8080/graduate.png" alt="graduate"></img><span>Groupes</span></button></Link>
       <Link to={'/GestionFiliere'}><button type='button' className='btns' ><img src="http://localhost:3001/book.png" alt="book"></img><span>Filieres</span></button></Link>
   </nav>
   <div className="split">
        <header>
            <div>
